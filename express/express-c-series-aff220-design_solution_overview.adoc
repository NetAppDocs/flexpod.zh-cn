...
image:express-c-series-aff220-design_image3.png["显示具有配置选项的 FlexPod Express 存储、交换和计算硬件系列的图表"]
...
image:express-c-series-aff220-design_image4.png["显示 Cisco Nexus 3172P 交换机、UCS C220 M5 服务器和 AFF A220 存储连接的图表"]
