...
+
image:express-c-series-c190-deploy_image17.png["Cisco CIMC Server BIOS 页面的屏幕截图，顶部菜单中带有 Launch KVM 链接"]
...
+
image:express-c-series-c190-deploy_image18.png["ESXi 安装程序选择容量为 15.00 GiB 的 NETAPP LUN C-Mode 存储设备的屏幕截图"]
...
+
image:express-c-series-c190-deploy_image19.png["选择 vmnic2 和 vmnic4 用于管理网络的 ESXi 网络适配器屏幕的屏幕截图"]
...
+
image:express-c-series-c190-deploy_image20.png["ESXi 网络页面的屏幕截图，其中\"虚拟交换机\"选项卡显示了 vSwitch0 和 iScsiBootvSwitch"]
...
+
image:express-c-series-c190-deploy_image21.png["iSCSIBootPG-A 组队和故障转移设置的屏幕截图，vmnic3 处于活动状态，vmnic5 未使用"]
...
+
image:express-c-series-c190-deploy_image22.png["选择了iSCSI软件适配器vmhba64的ESXi存储适配器选项卡的屏幕截图"]

. 在动态目标下，单击添加动态目标。
+
image:express-c-series-c190-deploy_image23.png["显示具有四个 IP 地址和端口 3260 的 iSCSI 动态目标的屏幕截图"]
...
.. 单击保存配置。
+
image:express-c-series-c190-deploy_image24.png["使用端口 3260 和\"保存配置\"按钮的四个 iSCSI 动态目标地址的屏幕截图"]
...
. 选择 vSwitch0 。
+
image:express-c-series-c190-deploy_image25.png["显示 MTU 9000 和活动 vmnic2 和 vmnic4 适配器的 ESXi vSwitch0 页面的屏幕截图"]
...
. 右键单击端口组选项卡。
+
image:express-c-series-c190-deploy_image26.png["选中\"端口组\"选项卡并添加可用端口组的 ESXi 网络页面的屏幕截图"]
...
. 单击 VMkernel NIC 选项卡。
+
image:express-c-series-c190-deploy_image27.png["列出vmk0和vmk1接口的ESXi Networking VMkernel NIC选项卡的屏幕截图"]
...
+
image:express-c-series-c190-deploy_image28.png["带有静态 IPv4 设置并已选择 vMotion 的\"添加 VMkernel NIC\"对话框的屏幕截图"]
...
+
image:express-c-series-c190-deploy_image29.png["显示\"新建数据存储区\"按钮的 VMware ESXi 存储页面的屏幕截图"]

. 选择挂载 NFS 数据存储库。
+
image:express-c-series-c190-deploy_image30.png["新建数据存储区向导的屏幕截图，其中已选择挂载 NFS 数据存储区作为创建类型"]
...
. 单击保存。
+
image:express-c-series-c190-deploy_image31.png["显示运行 NTP 服务和三个 NTP 服务器的 ESXi 时间和日期设置的屏幕截图"]
...
+
image:express-c-series-c190-deploy_image32.png["显示交换设置的 VMware ESXi Manage System Swap 页面的屏幕截图"]

. 单击编辑设置。从数据存储库选项中选择 `infra_swap` 。
+
image:express-c-series-c190-deploy_image33.png["编辑交换配置对话框的屏幕截图，其中 infra_swap 被选为数据存储区，另有保存和取消按钮"]
