...
+
image:express-c-series-aff220-deploy_image6.png["两个 HA 对节点和许可证的 System Manager Guided Setup 集群配置字段的屏幕截图"]
...
+
image:express-c-series-aff220-deploy_image7.png["OnCommand System Manager 支持设置（包含 AutoSupport 和事件通知字段）的屏幕截图"]
