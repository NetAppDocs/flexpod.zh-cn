...
image:express-c-series-c190-deploy_image1.png["显示包含用例的 FlexPod Express 和 FlexPod Datacenter 产品组合选项的图表"]
...
image:express-c-series-c190-deploy_image2.png["显示 FlexPod Express 交换机、C220 M5 服务器和 AFF C190 存储连接的图表"]
