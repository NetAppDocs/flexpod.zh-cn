...
image:express-direct-attach-aff220-deploy_image2.png["比较 FlexPod Express、FlexPod Datacenter 和 FlexPod Select 解决方案的图表"]
...
image:express-direct-attach-aff220-deploy_image3.png["显示用于管理、数据、IP、群集互连和 vPC 对等网络的 FlexPod Express 服务器、Nexus 交换机和 AFF 存储布线的图表"]
