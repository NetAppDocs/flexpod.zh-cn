...
+
image:express-c-series-c190-deploy_image5.png["显示 Cisco 服务器启动屏幕的屏幕截图，提示用户按 F8 进行 CIMC 设置"]
...
+
image:express-c-series-c190-deploy_image6.png["具有专用网卡且未选择冗余的 Cisco IMC Configuration Utility NIC Properties 的屏幕截图"]
...
+
image:express-c-series-c190-deploy_image7.png["Cisco Integrated Management Controller BIOS 配置引导顺序页面的屏幕截图"]
...
. 单击保存更改，然后单击关闭。
+
image:express-c-series-c190-deploy_image8.png["启用了 KVM-MAPPED-DVD、iSCSI-A 和 iSCSI-B 的高级引导顺序配置的屏幕截图"]
...
+
image:express-c-series-c190-deploy_image9.png["屏幕截图，显示禁用 PCIe 插槽 1 和插槽 2 选项 ROM 的 CIMC BIOS 设置"]
...
. 保存更改并重新启动 CIMC 。
+
image:express-c-series-c190-deploy_image10.png["未选中端口通道的 Cisco Integrated Management Controller 适配器卡 MLOM 常规选项卡的屏幕截图"]
...
** 将上行链路端口设置为 3 。
+
image:express-c-series-c190-deploy_image11.png["显示具有 VLAN 3439 和上行端口 1 的 iSCSI vNIC eth1 的常规设置的屏幕截图"]



. 选择左侧的 vNIC eth1 。
+
image:express-c-series-c190-deploy_image12.png["显示 vNIC eth1 的 iSCSI 启动属性启动器设置的屏幕截图"]
...
+
image:express-c-series-c190-deploy_image13.png["带有启动器、主目标和辅助目标详细信息的 iSCSI 启动属性的屏幕截图"]
...
+
image:express-c-series-c190-deploy_image14.png["显示带有启动器和目标设置的 vNIC eth3 的 iSCSI 引导属性的屏幕截图"]
...
. 将 VLAN 设置为原生 VLAN 2 。
+
image:express-c-series-c190-deploy_image15.png["具有 MTU 9000 和默认 VLAN 2 的 Cisco Integrated Management Controller vNIC eth0 属性的屏幕截图"]

. 对 eth1 重复步骤 3 和 4 ，验证 eth1 的上行链路端口是否设置为 1 。
+
image:express-c-series-c190-deploy_image16.png["Cisco Integrated Management Controller vNIC 列表屏幕截图，显示 eth0 至 eth3 及其 MTU、上行端口和 VLAN 设置"]
