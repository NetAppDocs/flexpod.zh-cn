...
image:express-c-series-c190-design_image1.png["将 FlexPod Express 部门部署与 FlexPod Datacenter 任务关键型工作负载进行比较的图表"]
...
image:express-c-series-c190-design_image2.png["显示 FlexPod Express 存储、交换机和服务器硬件选项的图表"]
...
image:express-c-series-c190-design_image3.png["显示 FlexPod Express 交换机、C220 M5 服务器和 AFF C190 存储连接的图表"]
