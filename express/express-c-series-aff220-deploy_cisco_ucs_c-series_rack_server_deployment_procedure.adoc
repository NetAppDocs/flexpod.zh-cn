...
+
image:express-c-series-aff220-deploy_image8.png["Cisco 服务器启动屏幕的屏幕截图，提示用户按 F8 进行 CIMC 设置"]
...
*** 无： [x]
+
image:express-c-series-aff220-deploy_image9.png["具有 IPv4 设置且未选择 NIC 冗余的 Cisco IMC NIC 属性的屏幕截图"]
...
*** 端口配置文件：保持清除状态。
+
image:express-c-series-aff220-deploy_image10.png["Cisco IMC 配置实用程序的屏幕截图，显示常见属性和端口设置"]
...
+
image:express-c-series-aff220-deploy_image11.png["已选择配置引导顺序的 Cisco Integrated Management Controller BIOS 设置的屏幕截图"]
...
. 单击保存更改，然后单击关闭。
+
image:express-c-series-aff220-deploy_image12.png["启用了 KVM-MAPPED-DVD、iSCSI-A 和 iSCSI-B 的高级引导顺序配置的屏幕截图"]
...
+
image:express-c-series-aff220-deploy_image13.png["屏幕截图，显示禁用 PCIe 插槽 1 和插槽 2 选项 ROM 的 CIMC BIOS 设置"]
...
+
image:express-c-series-aff220-deploy_image14.png["显示启用 MTU 9000、VLAN 3439、中继模式和 PXE 引导的 iSCSI-vNIC-A 设置的屏幕截图"]
...
+
image:express-c-series-aff220-deploy_image15.png["显示所选 iSCSI-vNIC-A 的屏幕截图，在 vNICs 选项卡上展开了 iSCSI 引导属性"]
...
+
image:express-c-series-aff220-deploy_image16.png["Cisco UCS iSCSI 引导属性的屏幕截图，显示启动器名称、IP 地址、子网掩码和网关字段"]
...
+
image:express-c-series-aff220-deploy_image17.png["显示具有主目标和二级 NetApp 目标的 iSCSI vNIC 启动器设置的屏幕截图"]
...
+
image:express-c-series-aff220-deploy_image18.png["列出 eth0、eth1 和两个 iSCSI vNIC 的 Cisco VIC vNIC 选项卡的屏幕截图"]

. 选择 eth0 并单击属性。
. 将 MTU 设置为 9000 。单击 Save Changes 。
+
image:express-c-series-aff220-deploy_image19.png["MTU 字段设置为 9000 的 Cisco VIC eth0 vNIC 属性屏幕截图"]

. 对 eth1 重复步骤 3 和 4 ，验证 eth1 的上行链路端口是否设置为 `1` 。
+
image:express-c-series-aff220-deploy_image20.png["显示 vNICs 选项卡的屏幕截图，其中 eth0 和 eth1 MTU 设置为 9000，上行链路端口为 0 和 1"]
