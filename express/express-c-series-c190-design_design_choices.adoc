...
image:express-c-series-c190-design_image4.png["显示两个带有 SFP+ 模块 UTA 2 端口的 AFF C190 控制器后视图的图表"]

下图显示了通过传统 RJ-45 以太网缆线连接的 10GBASE-T 端口。

image:express-c-series-c190-design_image5.png["显示带有 10GBASE-T RJ-45 端口的 AFF C190 系统后面板的示意图"]
...
有关 AFF C190 硬件系统的完整信息，请参见 https://docs.netapp.com/us-en/ontap-systems/c190/install-setup.html["NetApp AFF C190 文档"^]。
...
image:express-c-series-c190-design_image6.png["显示多个 4KB 逻辑块压缩成一个 4KB 物理块的图表"]
...
image:express-c-series-c190-design_image7.png["具有 48 个 SFP+ 端口和 6 个 QSFP28 端口的 Cisco Nexus 31108PC-V 交换机的前视图"]
...
image:express-c-series-c190-design_image8.png["具有双驱动器托架和 Cisco 品牌的 Cisco UCS C220 M5 机架式服务器的正面视图"]
...
image:express-c-series-c190-design_image9.png["带有四个 SFP28 端口和一个冷却风扇的 Cisco UCS VIC 1457 适配器的屏幕截图"]
...
image:express-c-series-c190-design_image10.png["显示连接到 VMware ESXi 6.7 U2 主机上 FlexPod 和 iSCSI 启动 vSwitches 的四个 vNIC 的示意图"]
