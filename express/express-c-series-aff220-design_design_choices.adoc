...
有关 AFF A220 硬件系统的详细信息，请参见 https://www.netapp.com/aff-a-series/["AFF A 系列主页"^]。
...
image:express-c-series-aff220-design_image5.png["显示多个 4KB 逻辑块压缩成一个 4KB 物理块的图表"]

此外，还可以在 AFF A220 系统上利用根数据分区功能。通过此分区，可以在系统中的磁盘之间对根聚合和两个数据聚合进行条带化。因此，双节点 AFF A220 集群中的两个控制器均可利用聚合中所有磁盘的性能。请参见下图。

image:express-c-series-aff220-design_image6.png["显示分区为根、Controller 1 和 Controller 2 分区的磁盘的示意图"]

这些只是补充 FlexPod Express 解决方案的几个关键功能。有关 ONTAP 9.4 的附加特性和功能的详细信息，请参见 https://www.netapp.com/pdf.html?item=/media/7413-ds-3231-ontap-unified-data-storage-management.pdf["ONTAP 9 数据管理软件产品规格"^]。此外，请参见 NetApp http://docs.netapp.com/ontap-9/index.jsp["ONTAP 9 文档中心"^]，其中已更新为包括 ONTAP 9.4。
...
image:express-c-series-aff220-design_image7.png["显示带有网络端口的 Cisco Nexus 3172 交换机前视图的屏幕截图"]
...
image:express-c-series-aff220-design_image8.png["具有双驱动器托架和 Cisco 品牌的 Cisco UCS C220 M5 机架式服务器的正面视图"]
...
image:express-c-series-aff220-design_image9.png["带有双 QSFP+ 端口和冷却风扇的 Cisco UCS VIC 1387 适配器卡"]
...
image:express-c-series-aff220-design_image10.png["Cisco CVR-QSFP-SFP10G QSFP 转 SFP 适配器模块的照片"]
