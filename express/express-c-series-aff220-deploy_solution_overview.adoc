...
image:express-c-series-aff220-deploy_image3.png["比较 FlexPod Express、Datacenter 和 Select 解决方案、目标和基础架构组件的图表"]
...
image:express-c-series-aff220-deploy_image4.png["显示 Cisco Nexus 3172P 交换机、UCS C220 M5 服务器和 AFF A220 存储连接的图表"]
