...
+
image:express-c-series-aff220-deploy_image41.png["突出显示\"获取 vCenter Server\"按钮的 VMware ESXi 主机页面的屏幕截图"]
...
+
image:express-c-series-aff220-deploy_image42.png["选择了 Embedded Platform Services Controller 的 vCenter Server Appliance 部署类型选择的屏幕截图"]
...
+
image:express-c-series-aff220-deploy_image43.png["包含 ESXi 主机、端口、root 用户和密码字段的 vCenter Server Appliance 部署目标页面的屏幕截图"]

. 输入 `vCSA` 作为要用于 VCSA 的 VM 名称和根密码，以设置设备 VM 。
+
image:express-c-series-aff220-deploy_image44.png["包含虚拟机名称和 root 密码字段的\"设置设备虚拟机\"页面的屏幕截图"]

. 选择最适合您环境的部署规模。单击下一步。
+
image:express-c-series-aff220-deploy_image45.png["显示选择了\"微型\"和\"默认\"存储的 vCenter Server 部署大小页面的屏幕截图"]

. 选择 infra_datastore_1 数据存储库。单击下一步。
+
image:express-c-series-aff220-deploy_image46.png["vCenter Server 安装程序\"选择数据存储\"页面的屏幕截图，其中已选择 infra_datastore_1"]
...
+
image:express-c-series-aff220-deploy_image47.png["vCenter Server Appliance Installer 的屏幕截图，其中显示了已填充静态 IPv4 字段的网络设置配置"]
...
. 在第 2 阶段简介页面上，单击下一步。
+
image:express-c-series-aff220-deploy_image48.png["vCenter Server Appliance Stage 2 简介页面（带有\"下一步\"按钮）的屏幕截图"]
