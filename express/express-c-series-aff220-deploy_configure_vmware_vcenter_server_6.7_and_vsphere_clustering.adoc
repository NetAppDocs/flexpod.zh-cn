...
. 单击确定。
+
image:express-c-series-aff220-deploy_image49.png["为集群 Tiger3 启用了 DRS 和 vSphere HA 的新集群对话框的屏幕截图"]
...
. 右键单击集群并选择添加主机。
+
image:express-c-series-aff220-deploy_image50.png["vSphere Web Client 屏幕截图，显示选择了 Add Host 的 FlexPod 集群 Actions 菜单"]
