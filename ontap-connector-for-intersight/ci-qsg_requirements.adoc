...
NOTE: 有关 Cisco UCS 计算组件和 UCSM 版本的最低要求，请参阅 https://intersight.com/help/saas/supported_systems/overview["Cisco Intersight支持的系统"^]。
...
有关各种许可等级所涵盖的功能的详细信息，请访问 https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["基础架构服务许可证"^]。
