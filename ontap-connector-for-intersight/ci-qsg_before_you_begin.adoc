...
安装或升级到Active IQ Unified Manager (需要最新版本、当前为9.13RC1)(如果尚未执行此操作)。有关说明，请转至 link:https://docs.netapp.com/us-en/active-iq-unified-manager/["NetApp Active IQ Unified Manager 文档"]。
