...
. 单击应用程序和层。
+
image:cloud-fabricpool_image14.png["显示 OnCommand System Manager 导航菜单的屏幕截图，其中已选择\"Applications  Tiers\""]

. 单击存储层。
. 单击某个聚合。
. 单击操作并选择附加云层。
+
image:cloud-fabricpool_image15.png["显示\"更多操作\"菜单并选择\"附加云层\"的屏幕截图"]
