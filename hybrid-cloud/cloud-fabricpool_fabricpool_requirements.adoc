...
NOTE: 请参阅 https://hwu.netapp.com/DetailViews/Home.aspx[] [NetApp Hardware Universe^]，以获取有关 FabricPool 支持平台的最新信息。

* NetApp ONTAP Select [NOTE] NetApp 建议使用全 SSD FabricPool 本地层。
* 云层
+
** 阿里云对象存储服务（标准，不常访问）
