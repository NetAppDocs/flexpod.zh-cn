...
有关 Intersight 许可和每个许可支持的功能的更多信息，请参见 https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["此处"^]。
...
将 Intersight Assist 纳入 Intersight 后，您可以使用"通过 Intersight Assist 声明"选项声明端点设备。有关详细信息，请参见 https://intersight.com/help/saas/getting_started/overview["入门"^]。
