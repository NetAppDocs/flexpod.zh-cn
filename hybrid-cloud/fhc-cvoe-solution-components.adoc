...
这种混合云解决方案可以扩展到任何运行受支持版本的软件、固件和硬件的FlexPod环境，具体定义见：link:http://support.netapp.com/matrix/["NetApp 互操作性表工具"^] ，link:https://ucshcltool.cloudapps.cisco.com/public/["UCS硬件和软件兼容性"^] ， 和link:https://www.vmware.com/resources/compatibility/search.php["VMware 兼容性指南"^]。
