...
image:cloud-fabricpool_image2.png["显示带有连接指南的 FlexPod 存储、Cisco Nexus 和 MDS 交换机以及 Cisco UCS 系列的图表"]
...
image:cloud-fabricpool_image3.png["显示 Cisco UCS、Nexus 93180YC-EX、AFF A300 和 MDS 9148S 连接的图表"]
