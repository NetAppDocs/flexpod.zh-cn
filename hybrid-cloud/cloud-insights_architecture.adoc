...
image:cloud-insights_image2.png["显示通过网络链路互连的 Cisco UCS、Nexus 交换机、NetApp AFF A800 控制器和 MDS 交换机的示意图"]
...
* 使用提供给 NetApp Digital Advisor 的数据分析环境，以评估存储系统风险并提出存储优化建议。
