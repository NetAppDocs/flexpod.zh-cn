...
image:medical-imaging_image8.png["显示具有 a0a ifgrps、VLAN 以及 NFS 和 iSCSI LIF 的 AFF A300 节点的图"]
...
* 请使用称为 https://www.netapp.com/pdf.html?item=/media/17229-tr4015.pdf["SnapMirror"^]的 NetApp 基于存储阵列的复制技术，而不是基于 vSphere 的复制。
