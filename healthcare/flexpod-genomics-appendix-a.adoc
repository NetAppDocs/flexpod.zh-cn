...
link:flexpod-genomics-genomics---gatk-setup-and-execution.html["上一篇：基因组学— GATK 设置和执行。"]
...
link:flexpod-genomics-appendix-b.html["Next ：使用 ` ./gatk` 脚本执行 GATK 的输出。"]
