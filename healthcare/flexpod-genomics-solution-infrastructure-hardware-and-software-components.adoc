...
image:flexpod-genomics-image6.png["显示具有 Cisco UCS、Nexus、MDS 和 NetApp AFF A700 连接的 FlexPod for Genomics 的示意图"]

下图显示了 FlexPod 布线详细信息。

image:flexpod-genomics-image7.png["显示 UCS、Nexus、NetApp AFF 和 MDS 交换机之间适用于基因组学的 FlexPod 布线的图表"]
