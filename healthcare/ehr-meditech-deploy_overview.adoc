...
* *存储效率*使用降低存储成本 https://www.netapp.com/media/79014-ng-937-Efficiency-Guarantee-Customer-Flyer.pdf["NetApp 7 ： 1 存储效率担保"^]。
...
有关MEDITECH工作负载说明的更多详细信息，请参见 https://www.netapp.com/pdf.html?item=/media/19872-tr-4190.pdf["TR-4190 ：《适用于 MEDITECH 环境的 NetApp 规模估算准则》"^]。
