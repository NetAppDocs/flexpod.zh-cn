...
image:sm-bcs-image2.png["显示 FlexPod Datacenter 组件的图表：Cisco UCS、Nexus/MDS 交换机和 NetApp AFF/FAS/ASA 存储"]
...
image:sm-bcs-image3.png["显示主数据中心和二级数据中心之间 SnapMirror 同步复制和自动故障转移的图表"]
