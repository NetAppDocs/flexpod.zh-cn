...
image:sm-bcs-image17.png["显示UCS 2204XP A和B通过10GBASE-KR连接到B200 M5 VIC的图表"]
...
image:sm-bcs-image18.png["显示连接到 FI 6454 交换机和 Nexus A 和 B 交换机的 UCS 5108 IOM 的示意图"]
...
image:sm-bcs-image19.png["显示 Cisco UCS Manager Set iSCSI Boot Parameters 对话框的屏幕截图，其中配置了两个静态目标"]
