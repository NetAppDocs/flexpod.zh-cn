...
image:sm-bcs-image4.png["显示 FlexPod 站点 A 和站点 B 之间延迟高达 10 毫秒，以及站点 C 的 ONTAP Mediator 的图表"]
...
image:sm-bcs-image5.png["显示 Cisco UCS C240/C245、C220/C225、B200 和 X210c M6 服务器的示意图"]
...
image:sm-bcs-image6.png["显示 UCS 2408、2304、2208XP、2204XP 和 UCSX 9108 模块前视图的图表"]
...
image:sm-bcs-image7.png["显示 Cisco UCS FI 6454、64108、6324、6332 和 6332-16UP 型号前面板的示意图"]
...
image:sm-bcs-image8.png["显示 Cisco UCS VIC 1440、1467、1455、1480、1477、1457、14825、14425 和 14000 桥接卡的图表"]
...
image:sm-bcs-image9.png["显示 Cisco Nexus 9336C-FX2、93180YC-FX3 和 3232C 交换机的示意图"]
...
image:sm-bcs-image10.png["显示 Cisco MDS 9132T、9148T、9148S、9250i 和 9396T 交换机前视图的图表"]
...
image:sm-bcs-image11.png["显示 NetApp AFF 和 ASA 控制器以及 DS 224C/2246 和 NS 224 磁盘架的图表"]
...
image:sm-bcs-image12.png["显示两个具有 SM-BC 关系的 FlexPod 站点以及站点 C 的 ONTAP Mediator 的图表"]
...
image:sm-bcs-image13.png["显示由扩展第 2 层链路和 ONTAP Mediator 连接的非对称 FlexPod 站点的图表"]
...
image:sm-bcs-image14.png["显示通过具有 SM-BC 关系的 VXLAN 多站点结构连接的 Intersight 和 UCSM 管理的 FlexPod 站点的图表"]

对于在城域中设有数据中心和多个分支机构的公司，这些公司都需要受到保护才能提供业务连续性， 可以实施下图所示的 FlexPod SM-BC 部署拓扑，以保护关键应用程序和数据服务，使所有分支站点实现零 RPO 和接近零 RTO 目标。

image:sm-bcs-image15.png["显示通过 VXLAN 多站点结构和 ONTAP Mediator 连接到数据中心的 FlexPod 分支站点的图表"]
